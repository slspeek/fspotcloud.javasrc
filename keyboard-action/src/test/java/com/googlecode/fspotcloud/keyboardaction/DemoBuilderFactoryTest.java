...
public class DemoBuilderFactoryTest {
    ...
    @Inject private DemoBuilderFactory demoBuilderFactory;
    @Inject private Runnable runnable;
    @Inject private ConfigBuilder configBuilder;
    @Inject
    ...
    public void setUp() throws Exception {
        ...
        configBuilder.register(configBuilder.createCategory("test"), MainBuilder.LOGIN_DEF,new Relevance());
    }
