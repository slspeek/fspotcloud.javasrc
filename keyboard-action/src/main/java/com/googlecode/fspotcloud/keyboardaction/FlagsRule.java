...
public class FlagsRule {
	...
	public boolean equals(Object o) {
		...
		if (!excludedFlags.equals(that.excludedFlags))
			return false;
		if (!necessaryFlags.equals(that.necessaryFlags))
			return false;
	...
	public String toString() {
		return Objects.toStringHelper(this).add("excludes", excludedFlags)
				.add("needed", necessaryFlags).toString();
	}
}
