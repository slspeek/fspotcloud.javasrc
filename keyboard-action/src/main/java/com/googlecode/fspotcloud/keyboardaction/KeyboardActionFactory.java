...
public class KeyboardActionFactory {
	...
	public KeyboardActionFactory(UIRegistrationBuilder builder,
			...
			HelpActionsFactory helpActionsFactory, ConfigBuilder configBuilder,
			IModeController modeController, ActionUIRegistry actionUIRegistry,
			List<ActionCategory> actionCategoryList,
			WidgetFactory widgetFactory,
			ActionToolbarResources actionToolbarResources,
			ResourcesSetup resourcesSetup, ToolbarFactory toolbarFactory) {
