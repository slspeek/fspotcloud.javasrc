...
public class WidgetFactory {
	...
	@Inject
	private WidgetFactory(EventBus eventBus, ActionUIRegistry actionUIRegistry,
	...
	public ActionButton getButton(ActionUIDef actionUIDef,
			ActionButtonResources buttonResources, String primaryStyleName) {
		final ActionButton actionButton = new ActionButton(actionUIDef,
				eventBus, buttonResources, primaryStyleName);
	...
	public ActionMenu getMenu(String caption) {
		...
		final ActionMenu actionMenu = new ActionMenu(caption, actionUIRegistry,
				eventBus, menuResources, actionMenuItemSafeHtml);
		return actionMenu;
	}
