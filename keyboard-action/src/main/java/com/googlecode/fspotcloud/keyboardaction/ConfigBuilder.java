...
public class ConfigBuilder {
	...
	private ConfigBuilder(ActionHandlerRegistry actionHandlerRegistry,
			...
			ActionUIRegistry actionUIRegistry, List<ActionCategory> categoryList) {
	...
	public ConfigBuilder addBinding(ActionCategory actionCategory,
			ActionUIDef actionUIDef, IActionHandler handler, Relevance relevance) {
		bindHandler(actionUIDef, handler);
		register(actionCategory, actionUIDef, relevance);
		return this;
	}

	public ConfigBuilder register(ActionCategory actionCategory,
			ActionUIDef actionUIDef, Relevance relevance) {
	...
	public ConfigBuilder bindHandler(ActionUIDef actionUIDef,
