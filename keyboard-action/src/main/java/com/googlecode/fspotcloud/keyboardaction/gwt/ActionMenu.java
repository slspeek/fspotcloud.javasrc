...
public class ActionMenu extends PushButton
		implements
			ClickHandler,
			MouseOverHandler,
			MouseOutHandler {
	...
	public ActionMenu(String caption, ActionUIRegistry actionUIRegistry,
			EventBus eventBus, ActionMenuResources actionMenuResources,
	...
	public void add(final String actionId) {
		...
		SafeHtml menuItemContent = actionMenuItemSafeHtml.get(actionUIDef,
				menuResources);
		MenuItem menuItem = innerBar.addItem(menuItemContent,
	...
	private void showPopup() {
		...
		popupPanel.setPopupPosition(
				popupPanel.getPopupLeft() + innerBar.getOffsetWidth() / 4,
				popupPanel.getPopupTop() - popupPanel.getOffsetHeight()
