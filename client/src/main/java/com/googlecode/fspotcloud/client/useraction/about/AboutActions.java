...
public class AboutActions {
    ...
    public AboutActions(Resources RESOURCES) {
        ...
        license = new ActionUIDef("license",
                "License",
                "View the license",
                RESOURCES.licenceIcon());
        project_hosting = new ActionUIDef("project-hosting",
                "Project site",
                "Go to the site on Google Project Hosting",
                RESOURCES.projectSiteIcon());
        f_spot = new ActionUIDef("f-spot",
                "F-Spot",
                "Go to the F-Spot site",
                RESOURCES.fspotIcon());
        proton = new ActionUIDef("proton",
                "Proton radio",
                "Go to the Proton Radio site",
                RESOURCES.protonIcon());
        build_server = new ActionUIDef("build-server",
                "Build server",
