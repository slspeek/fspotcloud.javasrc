...
public class DashboardBinder extends AbstractBinder {
    ...
    public void build() {
        ...
        Relevance binding = new Relevance(DashboardPlace.class).addDefaultKeys(KeyStroke.F)
        ...
        binding = new Relevance(DashboardPlace.class, TagApprovalPlace.class).addDefaultKeys(new KeyStroke('M'))
        ...
        binding = new Relevance(DashboardPlace.class).addDefaultKeys(SHIFT_CTRL_ALT_R);
        ...
        configBuilder.register(category, actions.deleteCommands,
                new Relevance(DashboardPlace.class).addDefaultKeys(new KeyStroke(Modifiers.CTRL, 'C')));
    ...
    private Relevance get(int characterCode) {
        return new Relevance(DashboardPlace.class).addDefaultKeys(new KeyStroke(characterCode));
    }
