...
public class GroupLateBinder {
	...
	GroupLateBinder(ConfigBuilder configBuilder,
			...
			GoEditUsergroup goEditUsergroup, GoManageUsers goManageUsers,
		...
		configBuilder.bindHandler(actions.deleteUsergroup,
		...
		configBuilder.bindHandler(actions.focusGroupTable,
				focusUsergroupTableHandler);
		...
		configBuilder
				.bindHandler(actions.focusEmailField, manageUsersPresenter);
		...
		configBuilder.bindHandler(actions.focusGrantedTable,
				tagApprovalPresenter);
		configBuilder.bindHandler(actions.focusRevokedTable,
				tagApprovalPresenter);
	}
}