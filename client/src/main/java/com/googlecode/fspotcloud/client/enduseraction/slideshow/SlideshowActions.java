...
public class SlideshowActions {
	...
	public SlideshowActions(Resources resources) {
		RESOURCES = resources;
		slideshow_faster = new ActionUIDef("faster", "Faster",
				"Makes the slideshow go faster", RESOURCES.fasterIcon());
		slideshow_slower = new ActionUIDef("slower", "Slower",
				"Makes the slideshow go slower", RESOURCES.slowerIcon());
		slideshow_pause = new ActionUIDef("pause", "Pause", "Pause slideshow",
				RESOURCES.pauseIcon());
		slideshow_stop = new ActionUIDef("stop", "Stop", "Stop slideshow",
				RESOURCES.stopIcon());
		slideshow_start = new ActionUIDef("play", "Play", "Start slideshow",
				RESOURCES.playIcon());
	}
}
