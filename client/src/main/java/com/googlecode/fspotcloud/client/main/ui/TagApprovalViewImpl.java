...
public class TagApprovalViewImpl extends Composite implements TagApprovalView {
	private final Logger log = Logger.getLogger(TagApprovalViewImpl.class
			.getName());
	private static final TagApprovalViewImplUiBinder uiBinder = GWT
			.create(TagApprovalViewImplUiBinder.class);
	...
	public TagApprovalViewImpl(GroupActions groupActions,
			...
			DashboardActions dashboardActions, AdminButtonFactory factory,
			StatusView statusView, CellTableResources cellTableResources
	...
	interface TagApprovalViewImplUiBinder
			extends
				UiBinder<Widget, TagApprovalViewImpl> {
	}
}
