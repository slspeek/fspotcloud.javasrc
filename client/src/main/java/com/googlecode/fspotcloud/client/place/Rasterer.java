...
public class Rasterer implements IRasterer {
	...
	@Inject
	private Rasterer(IPlaceController placeController, RasterState rasterState) {
		this.placeController = placeController;
		this.rasterState = rasterState;
	}

	private BasePlace getTabularPlace(BasePlace place) {
		return getResizedPlace(place, rasterState.getColumnCount(),
	...
	@Override
	public void toggleZoomView(String tagId, String photoId) {
