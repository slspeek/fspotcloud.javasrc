...
public class TagViewImpl extends Composite
		implements
			TagView,
			MouseOverHandler,
			MouseOutHandler {
	...
	private static final TagViewImplUiBinder uiBinder = GWT
	...
	public TagViewImpl(@BasicTreeView TreeView treeView,
			ImageRasterView imageRasterView, IModeController modeController,
			TimerInterface timer, @MainToolbar ActionToolbar actionToolbar) {
