...
public class AboutBinder extends AbstractBinder {
	...
	@Inject
	public AboutBinder(CategoryDef categoryDef,
			BuildServerHandler buildServerHandler, FSpotHandler fSpotHandler,
			LicenseHandler licenseHandler,
			ProjectSiteHandler projectSiteHandler, ProtonHandler protonHandler,
