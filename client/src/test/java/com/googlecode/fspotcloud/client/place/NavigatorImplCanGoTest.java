...
public class NavigatorImplCanGoTest {
	...
	private void canGo(BasePlace from, Navigator.Direction direction,
			Navigator.Unit unit, Boolean expectedResult, TagNode tagNode) {
	...
	private void canGoOneImage(Navigator.Direction direction,
			Navigator.Unit unit, Boolean expectedResult) {
		canGo(new BasePlace(TAG_ID, "42"), direction, unit, expectedResult,
	...
	{
		canGo(new BasePlace(TAG_ID, "101"), direction, unit, false,
				tagNodeTestFactory.getSingleNodeWithOnePicture());
	...
	private void canGoTwoImageFromEnd(Navigator.Direction direction,
			Navigator.Unit unit, Boolean expectedResult) {
		canGo(new BasePlace(TAG_ID, "102"), direction, unit, expectedResult,
				tagNodeTestFactory.getSingleNodeWithTwoPictures());
	...
	public void testOneImage() throws Exception {
		canGoOneImage(FORWARD, SINGLE, false);
		canGoOneImage(FORWARD, ROW, false);
		canGoOneImage(FORWARD, PAGE, false);
		canGoOneImage(FORWARD, BORDER, false);
		canGoOneImage(BACKWARD, SINGLE, false);
		canGoOneImage(BACKWARD, ROW, false);
		canGoOneImage(BACKWARD, PAGE, false);
		canGoOneImage(BACKWARD, BORDER, false);

	}

	@Test
	public void testTwoImagesHome() throws Exception {
		canGoTwoImageFromHome(FORWARD, SINGLE, true);
		canGoTwoImageFromHome(FORWARD, ROW, true);
		canGoTwoImageFromHome(FORWARD, PAGE, true);
		canGoTwoImageFromHome(FORWARD, BORDER, true);
		canGoTwoImageFromHome(BACKWARD, SINGLE, false);
		canGoTwoImageFromHome(BACKWARD, ROW, false);
		canGoTwoImageFromHome(BACKWARD, PAGE, false);
		canGoTwoImageFromHome(BACKWARD, BORDER, false);

	}

	@Test
	public void testTwoImagesEnd() throws Exception {
		canGoTwoImageFromEnd(FORWARD, SINGLE, false);
		canGoTwoImageFromEnd(FORWARD, ROW, false);
		canGoTwoImageFromEnd(FORWARD, PAGE, false);
		canGoTwoImageFromEnd(FORWARD, BORDER, false);
		canGoTwoImageFromEnd(BACKWARD, SINGLE, true);
		canGoTwoImageFromEnd(BACKWARD, ROW, true);
		canGoTwoImageFromEnd(BACKWARD, PAGE, true);
		canGoTwoImageFromEnd(BACKWARD, BORDER, true);
	}

	@Test
	public void testCanGoForwardTwoImages() throws Exception {
		canGo(new BasePlace(TAG_ID, "42"), FORWARD, SINGLE, true,
				tagNodeTestFactory.getSingleNodeWithTwoPictures());
	...
	public void testCanGoBackOneImage() throws Exception {
		canGo(new BasePlace(TAG_ID, "42"), BACKWARD, SINGLE, false,
				tagNodeTestFactory.getSingleNodeWithOnePicture());
	...
	public void testCanNotGoHomeOneImage() throws Exception {
		canGo(new BasePlace(TAG_ID, "42"), BACKWARD, BORDER, false,
				tagNodeTestFactory.getSingleNodeWithOnePicture());
	}
