...
public class DoubleImagePresenterImplTest {
    ...
    @Inject DoubleImagePresenterImpl presenter;
    ...
    public void testSetCurrentPlace() throws Exception {
        ...
        verify(navigator).getPageAsync(slideshowPlace.getTagId(), slideshowPlace.getPhotoId(), 1, presenter);
    ...
    public void testSetCurrentPlaceTwice() throws Exception {
        ...
        verify(navigator).getPageAsync(slideshowPlaceNext.getTagId(), slideshowPlaceNext.getPhotoId(), 1, presenter);
        presenter.setImage();
    }
