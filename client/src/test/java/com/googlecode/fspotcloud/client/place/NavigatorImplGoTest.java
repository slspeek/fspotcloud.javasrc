...
public class NavigatorImplGoTest {
    ...
    public void testGoForwardTwoImages() throws Exception {
        ...
        verify(placeController).goTo(new BasePlace(TAG_ID, TagNodeTestFactory.SECOND_PICTURE_INFO.getId()));
    }

    @Test
    public void testGoBackTwoImages() throws Exception {
        when(placeController.where()).thenReturn(new BasePlace(TAG_ID, TagNodeTestFactory.SECOND_PICTURE_INFO.getId()));
