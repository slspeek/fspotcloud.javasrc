...
public class SendPasswordResetHandlerTest {
    ...
    private SendPasswordResetAction action = new SendPasswordResetAction(RMS_FSF_ORG);
    ...
    public void testNotVerified() throws Exception {
        ...
        SendPasswordResetResult result = handler.execute(action, null);
        Assert.assertEquals(SendPasswordResetResult.Code.NOT_VERIFIED, result.getCode());
    }
    ...
    public void testSuccess() throws Exception {
        ...
        rms.setEnabled(true);
        SendPasswordResetResult result = handler.execute(action, null);
        Assert.assertEquals(SendPasswordResetResult.Code.SUCCESS, result.getCode());
