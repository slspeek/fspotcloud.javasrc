...
public class RequestFullsizeImageHandlerAllreadyLoadedAdminTest {
    ...
    public void setUp() throws Exception {
        ...
        when(imageHelper.getImage(photo, ImageHelper.Type.FULLSIZE)).thenReturn(imageBlob);
    ...
    public void testExecute() throws Exception {
        ...
        assertEquals(RequestFullsizeImageHandler.SUCCESSFULLY_MAILED, result.getMessage());
    }
}
